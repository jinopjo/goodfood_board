	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="main.jsp">
				<p style="font-weight: bold">맛짱</p>
			</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="bbs.jsp?boardID=1&pageNumber=1">맛짱 추천</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
        		...
        		<ul class="dropdown-menu">
        			<li><a href="mypageBbs.jsp?pageNumber=1">작성목록</a></li>
	...
	<div class="container">
		...
		<div class="container">
			<table class="table table-haver" style="border: 1px solid #dddddd">
					...
					<% 	
					String real = "C:\\jino\\ecl\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\finalProject\\bbsUpload";
								...
								<div class="row">
									<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
										...
										<tr>
											...
											<% 	
												String commentReal = "C:\\jino\\ecl\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\finalProject\\commentUpload";
